...
class Edge {
    ...
    public:
        ...
        /**
         * @brief Applies the impact of obstacles
         * @param vehicle The given vehicle
         * @param[out] delay The total delay
         * @param[out] speed The final speed
         */
        void applyImpact(const Vehicle& vehicle, double& delay, double& speed) const;
